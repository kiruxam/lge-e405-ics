...
/* LGE_CHANGE_S, [20120703][youngbae.choi@lge.com]
 * Auto interval time is set the 5 min.*/
#if 1
#define SECS_SCAN_WAIT		300	/* subsequent auto scanning delay */
#else /*original*/
#define SECS_SCAN_WAIT		600	/* subsequent auto scanning delay */
#endif
/* LGE_CHANGE_E, [20120703][youngbae.choi@lge.com] */
 ...
 * else log added */
	...
	if (new_leaks)
		...
		pr_info("suspected memory leaks no more(see "
			"/sys/kernel/debug/kmemleak)\n");
#else /*original*/
	if (new_leaks)
		pr_info("%d new suspected memory leaks (see "
