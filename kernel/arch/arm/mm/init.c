...
EXPORT_SYMBOL(membank1_start);
 ...
 //[U0][QCT PATCH][increase himem size without CONFIG_HIMEM][peter.jung@lge.com][20120622]
 // QCT PATCH - increasing vmalloc without high-mem.  bohyun.jung@lge.com  
...
void __init arm_memblock_init(struct meminfo *mi, struct machine_desc *mdesc)
{
	int i;
//[U0][QCT PATCH][increase himem size without CONFIG_HIMEM][peter.jung@lge.com][20120622]
#ifndef CONFIG_DONT_MAP_HOLE_AFTER_MEMBANK0	 // QCT PATCH - increasing vmalloc without high-mem.  bohyun.jung@lge.com 
