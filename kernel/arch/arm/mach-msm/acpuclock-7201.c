...
#if 1 //defined(CONFIG_MACH_MSM7X25A_M4) :: feature is not applied.
...
{
	uint32_t reg_clkctl, reg_clksel, clk_div, src_sel, /*added*/ a11_div;
	...
	//added
	// Perform overclocing if requested
	if (hunt_s->a11clk_khz>800000) {
		// Change speed of PLL2
