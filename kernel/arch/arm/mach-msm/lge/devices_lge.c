...
//LGE_CHANGE_S, [youngbae.choi@lge.com] , 2012-01-05
//LGE_CHANGE_S, [youngbae.choi@lge.com] , 2012-05-28 : for M4 model
#if 0
	if (machine_is_msm7x25a_m4())
		...
		fb_size = MSM_FB_SIZE;
#endif
//LGE_CHANGE_E, [youngbae.choi@lge.com] , 2012-05-28
//LGE_CHANGE_E, [youngbae.choi@lge.com] , 2012-01-05
...
//LGE_CHANGE_S, [youngbae.choi@lge.com] , 2012-05-28 : for M4 model
#if 0
 	if (machine_is_msm7625a_surf() || machine_is_msm7625a_ffa() || machine_is_msm7x25a_m4()) {
