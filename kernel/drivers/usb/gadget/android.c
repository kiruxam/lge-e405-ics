...
#include "f_serial.c"
// #include "f_acm.c" // not use, myunghwan.kim@lge.com
#include "f_adb.c"
#include "f_ccid.c"
#include "f_mtp.c"
...
#if 0 // not use, myunghwan.kim@lge.com
/* ACM */
...
#endif // not use, myunghwan.kim@lge.com
...
#endif /* CONFIG_LGE_USB_AUTORUN_DRIVER */
...
static struct android_usb_function *supported_functions[] = {
	...
	&adb_function,
	&ccid_function,
//	&acm_function, // not use, myunghwan.kim@lge.com
	&mtp_function,
	&ptp_function,
#ifdef CONFIG_LGE_USB_GADGET_DRIVER
	&ecm_function,
