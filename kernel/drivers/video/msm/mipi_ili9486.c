...
// when panic mode, lcd init no need.
	...
	{
		mipi_dsi_cmds_tx(mfd, &ili9486_tx_buf, ili9486_init_on_new_cmds,
...
{	
	...
	mipi_dsi_cmds_tx(mfd, &ili9486_tx_buf, &ili9486_tear_off_cmd, 1);
	...
	mipi_dsi_cmds_tx(mfd, &ili9486_tx_buf, &ili9486_tear_on_cmd, 1);	
