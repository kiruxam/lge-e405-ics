...
//LGE_CHANGE_E
  ...
  {0x20, 0x20, BYTE_LEN}, // STEVE Capture Hblank 288 -) 2180 + 288 one line 2468 
	...
	{0x21, 0x8c, BURST_TYPE}, // out2 Angle MIN steve outdoor awb angle min (for tree) 160
	{0x22, 0x01, BURST_TYPE}, // out2 Anble Max
	{0x23, 0x0e, BURST_TYPE}, // out2 Anble Max              sky limit
	{0x24, 0x00, BURST_TYPE}, // out1 Angle MIN
	{0x25, 0x82, BURST_TYPE}, // out1 Angle MIN //steve 
	{0x26, 0x01, BURST_TYPE}, // out1 Anble Max //iInAglMaxLmt_a00_n00
	{0x27, 0x01, BURST_TYPE}, // out1 Anble Max //iInAglMaxLmt_a00_n01
	           
	{0x28, 0x00, BURST_TYPE},
	{0x29, 0x69, BURST_TYPE}, //64(100) -) 73(115) yellow prev.
	...
	{0x3a, 0x00, BURST_TYPE},
  {0x3b, 0x09, BURST_TYPE}, //dwOut1StrLmtTh_a00_n01
  {0x3c, 0x02, BURST_TYPE}, //dwOut1StrLmtTh_a00_n02
  {0x3d, 0x34, BURST_TYPE}, //dwOut1StrLmtTh_a00_n03
	{0x3e, 0x00, BURST_TYPE},
	...
	{0x4d, 0x1a, BURST_TYPE},  // steve L outdoor -) indoor(EV) 
	...
	{0x14, 0xFC, BURST_TYPE},
	{0x15, 0x57, BURST_TYPE},
	{0x16, 0xE9, BURST_TYPE},
	...
	{0x3f, 0x32, BURST_TYPE},  //YLVL_00
	{0x40, 0x32, BURST_TYPE},  //YLVL_01
	{0x41, 0x32, BURST_TYPE},  //YLVL_02
...
//LGE_CHANGE_S MR LOW Light Tuning	           
	...
	{0x2e, 0x88, BURST_TYPE},//SATB_03  
	{0x2f, 0x88, BURST_TYPE},//SATB_04  
	{0x30, 0x88, BURST_TYPE},//SATB_05
	{0x31, 0x90, BURST_TYPE},//SATB_06
	{0x32, 0x90, BURST_TYPE},//SATB_07
	{0x33, 0x90, BURST_TYPE},//SATB_08
	{0x34, 0x90, BURST_TYPE},//SATB_09
	{0x35, 0x90, BURST_TYPE},//SATB_10
	{0x36, 0x90, BURST_TYPE},//SATB_11 

	//Cr		

	{0x37, 0x88, BURST_TYPE},//SATR_00 STEVE for Low Light 
	{0x38, 0x88, BURST_TYPE},//SATR_01 STEVE for Low Light 
	{0x39, 0x88, BURST_TYPE},//SATR_02 STEVE for Low Light 
	{0x3a, 0x88, BURST_TYPE},//SATR_03
	{0x3b, 0x88, BURST_TYPE},//SATR_04
	{0x3c, 0x88, BURST_TYPE},//SATR_05
	{0x3d, 0x90, BURST_TYPE},//SATR_06
	{0x3e, 0x90, BURST_TYPE},//SATR_07
	{0x3f, 0x90, BURST_TYPE},//SATR_08
	{0x40, 0x90, BURST_TYPE},//SATR_09
	{0x41, 0x90, BURST_TYPE},//SATR_10
	{0x42, 0x90, BURST_TYPE},//SATR_11
...
//LGE_CHANGE_S MR LOW Light Tuning
	...
	{0x1b, 0x60, BURST_TYPE}, //LSC 00 Gain GB
	{0x1c, 0x64, BURST_TYPE}, //LSC 00 Gain B 
	{0x1d, 0x64, BURST_TYPE}, //LSC 00 Gain R
	{0x1e, 0x60, BURST_TYPE}, //LSC 00 Gain GR
	...
	{0x23, 0x60, BURST_TYPE}, //LSC 01 Gain GB
	{0x24, 0x64, BURST_TYPE}, //LSC 01 Gain B 
	{0x25, 0x65, BURST_TYPE}, //LSC 01 Gain R 
	{0x26, 0x60, BURST_TYPE}, //LSC 01 Gain GR
	...
	{0x2b, 0x60, BURST_TYPE}, //LSC 02 Gain GB
	{0x2c, 0x64, BURST_TYPE}, //LSC 02 Gain B 
	{0x2d, 0x66, BURST_TYPE}, //LSC 02 Gain R 
	{0x2e, 0x60, BURST_TYPE}, //LSC 02 Gain GR
...
{ 0xbc, 0x80, BYTE_LEN}, //bOutBgainMax_a00_n00
	...
	// STEVE SATB 
{ 0x2b, 0x88, BYTE_LEN},//SATB_00"
{ 0x2c, 0x88, BYTE_LEN},//SATB_01"
{ 0x2d, 0x88, BYTE_LEN},//SATB_02"
{ 0x2e, 0x88, BYTE_LEN},//SATB_03"
{ 0x2f, 0x88, BYTE_LEN},//SATB_04"
{ 0x30, 0x88, BYTE_LEN},//SATB_05"
{ 0x31, 0x90, BYTE_LEN},//SATB_06"
{ 0x32, 0x90, BYTE_LEN},//SATB_07"
{ 0x33, 0x90, BYTE_LEN},//SATB_08"
{ 0x34, 0x90, BYTE_LEN},//SATB_09"
{ 0x35, 0x90, BYTE_LEN},//SATB_10"
{ 0x36, 0x90, BYTE_LEN},//SATB_11"

	// STEVE SATR 
{ 0x37, 0x88, BYTE_LEN},//SATR_00"
{ 0x38, 0x88, BYTE_LEN},//SATR_01"
{ 0x39, 0x88, BYTE_LEN},//SATR_02"
{ 0x3a, 0x88, BYTE_LEN},//SATR_03"
{ 0x3b, 0x88, BYTE_LEN},//SATR_04"
{ 0x3c, 0x88, BYTE_LEN},//SATR_05"
{ 0x3d, 0x90, BYTE_LEN},//SATR_06"
{ 0x3e, 0x90, BYTE_LEN},//SATR_07"
{ 0x3f, 0x90, BYTE_LEN},//SATR_08"
{ 0x40, 0x90, BYTE_LEN},//SATR_09"
{ 0x41, 0x90, BYTE_LEN},//SATR_10"
{ 0x42, 0x90, BYTE_LEN},//SATR_11"
...
struct hi351_i2c_reg_conf hi351_wb_incandescent_settings[] = {
	...
	{0x1a, 0x90, BYTE_LEN}, //bInBgainMin_a00_n00 
	{0x1b, 0xAC, BYTE_LEN}, //bInBgainMax_a00_n00 
	
	{0xb9, 0x3C, BYTE_LEN}, //bOutRgainMin_a00_n00  
	{0xba, 0x59, BYTE_LEN}, //bOutRgainMax_a00_n00  
			
	{0xbb, 0x90, BYTE_LEN}, //bOutBgainMin_a00_n00  
	{0xbc, 0xAC, BYTE_LEN}, //bOutBgainMax_a00_n00  
	{0x03, 0xc5, BYTE_LEN},
	{0x10, 0xb1, BYTE_LEN}, //AWB On
...
struct hi351_i2c_reg_conf hi351_wb_daylight_settings[] = {
	...
	{0xb9, 0x5d, BYTE_LEN}, //bOutRgainMin_a00_n00  
	{0xba, 0x6A, BYTE_LEN}, //bOutRgainMax_a00_n00  
			
	{0xbb, 0x62, BYTE_LEN}, //bOutBgainMin_a00_n00  
