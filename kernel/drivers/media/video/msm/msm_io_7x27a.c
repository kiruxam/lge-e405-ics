...
//LGE_CHANGE_S: MIPI HW Block Setting (MIPI 1module: block 3 / MIPI 2modules: block 2) hong.junki@lge.com 2012-02-16 
#ifdef CONFIG_HI351
...
int msm_camio_csi_config(struct msm_camera_csi_params *csi_params)
{
	...
	CDBG("%s MIPI_PHY_D0_CONTROL2 val=0x%x\n", __func__, val);
	msm_io_w(val, csibase + MIPI_PHY_D0_CONTROL2);
//LGE_CHANGE_S: MIPI HW Block Setting (MIPI 1module: block 3line / MIPI 2modules: block 2line) hong.junki@lge.com 2012-02-16
#ifdef CONFIG_HI351
//	msm_io_w(val, csibase + MIPI_PHY_D1_CONTROL2);		//This line can be open if the model uses 2 cameras
//	msm_io_w(val, csibase + MIPI_PHY_D2_CONTROL2);
//	msm_io_w(val, csibase + MIPI_PHY_D3_CONTROL2);
